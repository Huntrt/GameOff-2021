...
public class Controls : MonoBehaviour
{
	...
	void Update()
	{
		...
		if(Input.GetKeyDown(Keybind.i.GetKey("Halt"))) {StopFromation();}
		...
		if(Input.GetKeyUp(Keybind.i.GetKey("Move"))) {indi.RemoveMoveIndicator();}
	}
	...
	void Selecting()
	{
		...
		if(Input.GetKeyUp(Keybind.i.GetKey("Attack")))
		{
